...
from app.agent.retry_helper import gemini_retry_decorator

@gemini_retry_decorator
def _call_planner_api(client: genai.Client, prompt: str) -> Any:
...
def plan_task(
    ...
    try:
        response = _call_planner_api(client, prompt)
        import json
